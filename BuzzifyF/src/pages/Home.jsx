...
const Home = () => {
  return (
    <>
      <div
        className="h-screen bg-cover bg-center flex flex-col items-start justify-between" style={{ backgroundImage: "url('assets/welcome_img.jpeg')" }} id='home-page'>
        <img className='h-[7.6rem]' id='logo' src="assets/logo.re.png" alt="logo" />
